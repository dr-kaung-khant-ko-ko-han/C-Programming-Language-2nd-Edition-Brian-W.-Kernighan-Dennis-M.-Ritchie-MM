...
Pointer subtraction is also valid: if p and q point to elements of the same array, and p, then q-p+1 is the number of elements from p to q inclusive. This fact can be used to write yet another version of strlen:
